...
export function FollowersDialog({ open, onOpenChange, username }: FollowersDialogProps) {
    const [page, setPage] = useState(0);
    const { data: followersData, isLoading } = useFollowers(username, page);
            ...
            <DialogContent className="sm:max-w-125 bg-black border-gray-700 text-white">
                ...
                <div className="max-h-100 overflow-y-auto">
                    {isLoading ? (
                        ...
                        <div className="py-8 text-center text-gray-400">No followers yet</div>
                    )}
                </div>
            </DialogContent>
        </Dialog>
...
function FollowerItem({ user, currentUsername }: FollowerItemProps) {
